    ...
    <div className="flex sm:px-20 px-5 w-full justify-center mt-20">
      <div className="">
        <h1
          translate="no"
          data-aos="zoom-in"
          className="text-center mb-3 sm:mb-[70px] text-gray-700 dark:text-gray-300 font-medium pt-5 w-full text-[35px] 
        ...
        <h1
          translate="no"
          data-aos="zoom-in"
          className="text-lg text-center text-[#222222] dark:text-gray-300 transition-transform duration-300 hover:scale-105"
        >
